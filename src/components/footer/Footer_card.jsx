...
const Footer_card = () => {
    return (
            <div className='border-3 border-white w-[95%] md:max-w-[1240px] mx-auto m-5 mt16 md:mt-28 rounded-2xl -mb-[90px] md:-mb-[120px] z-10 relative'>
                <div className="max-w-[1200px] border-2 border-gray-200 md:mx-auto my-4 mx-4 pt-12 pb-8 px-5 md:p-[88px] min-h-[200px] bg-white bg-cover bg-center bg-no-repeat rounded-2xl shadow-2xl"
